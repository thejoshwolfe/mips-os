...
{
	private static final long serialVersionUID = 207172505884326621L;
	...
	public void init()
	{
		...
		rootContainer.add(spnEditor, BorderLayout.CENTER);
		 pnlControls = new JPanel(new FlowLayout());
		  ...
		  btnAssem.addActionListener(new ActionListener() {public void actionPerformed(ActionEvent arg0) {assemble();}});
